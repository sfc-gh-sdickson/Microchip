...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_ENGINEERS (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_WINS (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS(engineer_id),
...
CREATE OR REPLACE TABLE PRODUCTION_ORDERS (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (design_win_id) REFERENCES DESIGN_WINS(design_win_id),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS(distributor_id)
...
CREATE OR REPLACE TABLE QUALITY_ISSUES (
    ...
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS(customer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG(product_id),
    FOREIGN KEY (reported_by_engineer_id) REFERENCES DESIGN_ENGINEERS(engineer_id)
);
