...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS dw
JOIN PRODUCT_CATALOG p ON dw.product_id = p.product_id
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS c
JOIN DESIGN_ENGINEERS e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG p
