...
4. Test Cortex Search with sample queries
...
└─────────────────────────────────────────────────────────────────┘
       ...
       │  • Customers, Engineers, Products        │
       │  • Design Wins, Production Orders        │
       │  • Orders, Distributors                  │
       │  • Support Contracts, Certifications     │
       │  • Support Tickets, Quality Issues       │
       │  • Marketing Campaigns                   │
       │  • Support Transcripts (Unstructured)    │
       │  • Application Notes (Unstructured)      │
       │  • Quality Reports (Unstructured)        │
       └──────────────────────────────────────────┘
```
