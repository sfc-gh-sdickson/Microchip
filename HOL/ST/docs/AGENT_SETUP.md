...
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.SUPPORT_TRANSCRIPTS_SEARCH_ST TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.APPLICATION_NOTES_SEARCH_ST TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.QUALITY_INVESTIGATION_REPORTS_SEARCH_ST TO ROLE <your_role>;
```
...
1. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_ST.RAW_ST.SUPPORT_TRANSCRIPTS_SEARCH_ST`
2. **Add a description**:
   ```
...
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_ST.RAW_ST.APPLICATION_NOTES_SEARCH_ST`
3. **Add a description**:
   ```
...
1. Click **+ Add** again for another Cortex Search
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_ST.RAW_ST.QUALITY_INVESTIGATION_REPORTS_SEARCH_ST`
3. **Add a description**:
   ```
...
SELECT PARSE_JSON(
  SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
      'MICROCHIP_INTELLIGENCE_ST.RAW_ST.SUPPORT_TRANSCRIPTS_SEARCH_ST',
