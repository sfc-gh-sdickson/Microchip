...
-- ============================================================================
INSERT INTO DISTRIBUTORS_ST VALUES
...
-- ============================================================================
INSERT INTO PRODUCT_CATALOG_ST VALUES
...
-- ============================================================================
INSERT INTO SUPPORT_ENGINEERS_ST
SELECT
...
-- ============================================================================
INSERT INTO DESIGN_ENGINEERS_ST
SELECT
...
-- ============================================================================
INSERT INTO MARKETING_CAMPAIGNS_ST
SELECT
...
-- ============================================================================
INSERT INTO SUPPORT_CONTRACTS_ST
SELECT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_ENGINEERS_ST e
JOIN CUSTOMERS_ST c ON e.customer_id = c.customer_id
CROSS JOIN PRODUCT_CATALOG_ST p
CROSS JOIN DISTRIBUTORS_ST d
...
-- ============================================================================
INSERT INTO PRODUCTION_ORDERS_ST
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS_ST dw
JOIN PRODUCT_CATALOG_ST p ON dw.product_id = p.product_id
...
-- ============================================================================
INSERT INTO CUSTOMER_CAMPAIGN_INTERACTIONS_ST
SELECT
...
FROM CUSTOMERS_ST c
CROSS JOIN MARKETING_CAMPAIGNS_ST mc
...
-- ============================================================================
INSERT INTO SUPPORT_TICKETS_ST
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS_ST c
JOIN DESIGN_ENGINEERS_ST e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG_ST p
...
-- ============================================================================
INSERT INTO CERTIFICATION_VERIFICATIONS_ST
SELECT
