...
CREATE OR REPLACE SEMANTIC VIEW SV_DESIGN_ENGINEERING_INTELLIGENCE_ST
  TABLES (
    ...
    production_orders AS RAW_ST.PRODUCTION_ORDERS_ST
    ...
    certifications AS RAW_ST.CERTIFICATIONS_ST
...
WHERE TABLE_SCHEMA = 'ANALYTICS_ST'
  AND table_name LIKE 'SV_%'
ORDER BY table_name;

-- Show semantic view details
SHOW SEMANTIC VIEWS IN SCHEMA ANALYTICS_ST;
