...
-- Create the database
CREATE DATABASE IF NOT EXISTS MICROCHIP_INTELLIGENCE_ST;

-- Use the database
USE DATABASE MICROCHIP_INTELLIGENCE_ST;

-- Create schemas
CREATE SCHEMA IF NOT EXISTS RAW_ST;
CREATE SCHEMA IF NOT EXISTS ANALYTICS_ST;

-- Create a virtual warehouse for query processing
CREATE OR REPLACE WAREHOUSE MICROCHIP_WH_ST WITH
