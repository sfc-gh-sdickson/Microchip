...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMERS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_ENGINEERS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_CONTRACTS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCT_CATALOG_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE DISTRIBUTORS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_WINS_ST (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_ST(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_ST(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_ST(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_ST(distributor_id)
);

-- ============================================================================
-- PRODUCTION_ORDERS TABLE (from COURSE_COMPLETIONS)
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCTION_ORDERS_ST (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (design_win_id) REFERENCES DESIGN_WINS_ST(design_win_id),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_ST(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_ST(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_ST(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_ST(distributor_id)
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATIONS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATION_VERIFICATIONS_ST (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (certification_id) REFERENCES CERTIFICATIONS_ST(certification_id)
);

-- ============================================================================
-- ORDERS TABLE (from TRANSACTIONS)
-- ============================================================================
CREATE OR REPLACE TABLE ORDERS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_TICKETS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_ENGINEERS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE QUALITY_ISSUES_ST (
    ...
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_ST(customer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_ST(product_id),
    FOREIGN KEY (reported_by_engineer_id) REFERENCES DESIGN_ENGINEERS_ST(engineer_id)
);

-- ============================================================================
-- MARKETING_CAMPAIGNS TABLE
-- ============================================================================
CREATE OR REPLACE TABLE MARKETING_CAMPAIGNS_ST (
...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMER_CAMPAIGN_INTERACTIONS_ST (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_ST(customer_id),
    FOREIGN KEY (campaign_id) REFERENCES MARKETING_CAMPAIGNS_ST(campaign_id)
);
