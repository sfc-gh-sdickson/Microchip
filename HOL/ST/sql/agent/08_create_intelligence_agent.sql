...
GRANT USAGE ON DATABASE MICROCHIP_INTELLIGENCE_ST TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_ST.RAW_ST TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.SV_DESIGN_ENGINEERING_INTELLIGENCE_ST TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.SV_SALES_REVENUE_INTELLIGENCE_ST TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.SV_CUSTOMER_SUPPORT_INTELLIGENCE_ST TO ROLE SYSADMIN;
GRANT USAGE ON WAREHOUSE MICROCHIP_WH_ST TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.SUPPORT_TRANSCRIPTS_SEARCH_ST TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.APPLICATION_NOTES_SEARCH_ST TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_ST.RAW_ST.QUALITY_INVESTIGATION_REPORTS_SEARCH_ST TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.PREDICT_REVENUE_ST(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.PREDICT_CUSTOMER_CHURN_ST(STRING) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_ST.ANALYTICS_ST.PREDICT_DESIGN_WIN_CONVERSION_ST(STRING) TO ROLE SYSADMIN;
...
GRANT USAGE ON AGENT MICROCHIP_INTELLIGENCE_AGENT_ST TO ROLE SYSADMIN;
