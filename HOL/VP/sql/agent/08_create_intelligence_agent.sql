...
GRANT USAGE ON DATABASE MICROCHIP_INTELLIGENCE_VP TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_VP.RAW_VP TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.SV_DESIGN_ENGINEERING_INTELLIGENCE_VP TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.SV_SALES_REVENUE_INTELLIGENCE_VP TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.SV_CUSTOMER_SUPPORT_INTELLIGENCE_VP TO ROLE SYSADMIN;
GRANT USAGE ON WAREHOUSE MICROCHIP_WH_VP TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_VP.RAW_VP.SUPPORT_TRANSCRIPTS_SEARCH_VP TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_VP.RAW_VP.APPLICATION_NOTES_SEARCH_VP TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_VP.RAW_VP.QUALITY_INVESTIGATION_REPORTS_SEARCH_VP TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.PREDICT_REVENUE_VP(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.PREDICT_CUSTOMER_CHURN_VP(STRING) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_VP.ANALYTICS_VP.PREDICT_DESIGN_WIN_CONVERSION_VP(STRING) TO ROLE SYSADMIN;
...
GRANT USAGE ON AGENT MICROCHIP_INTELLIGENCE_AGENT_VP TO ROLE SYSADMIN;
