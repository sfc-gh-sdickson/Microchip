...
CREATE OR REPLACE SEMANTIC VIEW SV_DESIGN_ENGINEERING_INTELLIGENCE_VP
  TABLES (
    ...
    production_orders AS RAW_VP.PRODUCTION_ORDERS_VP
    ...
    certifications AS RAW_VP.CERTIFICATIONS_VP
...
WHERE TABLE_SCHEMA = 'ANALYTICS_VP'
  AND table_name LIKE 'SV_%'
ORDER BY table_name;

-- Show semantic view details
SHOW SEMANTIC VIEWS IN SCHEMA ANALYTICS_VP;
