...
GRANT USAGE ON DATABASE MICROCHIP_INTELLIGENCE_MB TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_MB.RAW_MB TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.SV_DESIGN_ENGINEERING_INTELLIGENCE_MB TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.SV_SALES_REVENUE_INTELLIGENCE_MB TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.SV_CUSTOMER_SUPPORT_INTELLIGENCE_MB TO ROLE SYSADMIN;
GRANT USAGE ON WAREHOUSE MICROCHIP_WH_MB TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.SUPPORT_TRANSCRIPTS_SEARCH_MB TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.APPLICATION_NOTES_SEARCH_MB TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.QUALITY_INVESTIGATION_REPORTS_SEARCH_MB TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.PREDICT_REVENUE_MB(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.PREDICT_CUSTOMER_CHURN_MB(STRING) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_MB.ANALYTICS_MB.PREDICT_DESIGN_WIN_CONVERSION_MB(STRING) TO ROLE SYSADMIN;
...
GRANT USAGE ON AGENT MICROCHIP_INTELLIGENCE_AGENT_MB TO ROLE SYSADMIN;
