...
-- Create the database
CREATE DATABASE IF NOT EXISTS MICROCHIP_INTELLIGENCE_MB;

-- Use the database
USE DATABASE MICROCHIP_INTELLIGENCE_MB;

-- Create schemas
CREATE SCHEMA IF NOT EXISTS RAW_MB;
CREATE SCHEMA IF NOT EXISTS ANALYTICS_MB;

-- Create a virtual warehouse for query processing
CREATE OR REPLACE WAREHOUSE MICROCHIP_WH_MB WITH
