...
-- ============================================================================
INSERT INTO DISTRIBUTORS_MB VALUES
...
-- ============================================================================
INSERT INTO PRODUCT_CATALOG_MB VALUES
...
-- ============================================================================
INSERT INTO SUPPORT_ENGINEERS_MB
SELECT
...
-- ============================================================================
INSERT INTO DESIGN_ENGINEERS_MB
SELECT
...
-- ============================================================================
INSERT INTO MARKETING_CAMPAIGNS_MB
SELECT
...
-- ============================================================================
INSERT INTO SUPPORT_CONTRACTS_MB
SELECT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_ENGINEERS_MB e
JOIN CUSTOMERS_MB c ON e.customer_id = c.customer_id
CROSS JOIN PRODUCT_CATALOG_MB p
CROSS JOIN DISTRIBUTORS_MB d
...
-- ============================================================================
INSERT INTO PRODUCTION_ORDERS_MB
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS_MB dw
JOIN PRODUCT_CATALOG_MB p ON dw.product_id = p.product_id
...
-- ============================================================================
INSERT INTO CUSTOMER_CAMPAIGN_INTERACTIONS_MB
SELECT
...
FROM CUSTOMERS_MB c
CROSS JOIN MARKETING_CAMPAIGNS_MB mc
...
-- ============================================================================
INSERT INTO SUPPORT_TICKETS_MB
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS_MB c
JOIN DESIGN_ENGINEERS_MB e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG_MB p
...
-- ============================================================================
INSERT INTO CERTIFICATION_VERIFICATIONS_MB
SELECT
