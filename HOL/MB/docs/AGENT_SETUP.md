...
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.SUPPORT_TRANSCRIPTS_SEARCH_MB TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.APPLICATION_NOTES_SEARCH_MB TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_MB.RAW_MB.QUALITY_INVESTIGATION_REPORTS_SEARCH_MB TO ROLE <your_role>;
```
...
1. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_MB.RAW_MB.SUPPORT_TRANSCRIPTS_SEARCH_MB`
2. **Add a description**:
   ```
...
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_MB.RAW_MB.APPLICATION_NOTES_SEARCH_MB`
3. **Add a description**:
   ```
...
1. Click **+ Add** again for another Cortex Search
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_MB.RAW_MB.QUALITY_INVESTIGATION_REPORTS_SEARCH_MB`
3. **Add a description**:
   ```
