...
CREATE OR REPLACE SEMANTIC VIEW SV_DESIGN_ENGINEERING_INTELLIGENCE_RN
  TABLES (
    ...
    production_orders AS RAW_RN.PRODUCTION_ORDERS_RN
    ...
    certifications AS RAW_RN.CERTIFICATIONS_RN
...
WHERE TABLE_SCHEMA = 'ANALYTICS_RN'
  AND table_name LIKE 'SV_%'
ORDER BY table_name;

-- Show semantic view details
SHOW SEMANTIC VIEWS IN SCHEMA ANALYTICS_RN;
