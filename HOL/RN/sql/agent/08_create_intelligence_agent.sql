...
GRANT USAGE ON DATABASE MICROCHIP_INTELLIGENCE_RN TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_RN.RAW_RN TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.SV_DESIGN_ENGINEERING_INTELLIGENCE_RN TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.SV_SALES_REVENUE_INTELLIGENCE_RN TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.SV_CUSTOMER_SUPPORT_INTELLIGENCE_RN TO ROLE SYSADMIN;
GRANT USAGE ON WAREHOUSE MICROCHIP_WH_RN TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_RN.RAW_RN.SUPPORT_TRANSCRIPTS_SEARCH_RN TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_RN.RAW_RN.APPLICATION_NOTES_SEARCH_RN TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_RN.RAW_RN.QUALITY_INVESTIGATION_REPORTS_SEARCH_RN TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.PREDICT_REVENUE_RN(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.PREDICT_CUSTOMER_CHURN_RN(STRING) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_RN.ANALYTICS_RN.PREDICT_DESIGN_WIN_CONVERSION_RN(STRING) TO ROLE SYSADMIN;
...
GRANT USAGE ON AGENT MICROCHIP_INTELLIGENCE_AGENT_RN TO ROLE SYSADMIN;
