...
-- Create the database
CREATE DATABASE IF NOT EXISTS MICROCHIP_INTELLIGENCE_RN;

-- Use the database
USE DATABASE MICROCHIP_INTELLIGENCE_RN;

-- Create schemas
CREATE SCHEMA IF NOT EXISTS RAW_RN;
CREATE SCHEMA IF NOT EXISTS ANALYTICS_RN;

-- Create a virtual warehouse for query processing
CREATE OR REPLACE WAREHOUSE MICROCHIP_WH_RN WITH
