...
-- ============================================================================
INSERT INTO DISTRIBUTORS_RN VALUES
...
-- ============================================================================
INSERT INTO PRODUCT_CATALOG_RN VALUES
...
-- ============================================================================
INSERT INTO SUPPORT_ENGINEERS_RN
SELECT
...
-- ============================================================================
INSERT INTO DESIGN_ENGINEERS_RN
SELECT
...
-- ============================================================================
INSERT INTO MARKETING_CAMPAIGNS_RN
SELECT
...
-- ============================================================================
INSERT INTO SUPPORT_CONTRACTS_RN
SELECT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_ENGINEERS_RN e
JOIN CUSTOMERS_RN c ON e.customer_id = c.customer_id
CROSS JOIN PRODUCT_CATALOG_RN p
CROSS JOIN DISTRIBUTORS_RN d
...
-- ============================================================================
INSERT INTO PRODUCTION_ORDERS_RN
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS_RN dw
JOIN PRODUCT_CATALOG_RN p ON dw.product_id = p.product_id
...
-- ============================================================================
INSERT INTO CUSTOMER_CAMPAIGN_INTERACTIONS_RN
SELECT
...
FROM CUSTOMERS_RN c
CROSS JOIN MARKETING_CAMPAIGNS_RN mc
...
-- ============================================================================
INSERT INTO SUPPORT_TICKETS_RN
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS_RN c
JOIN DESIGN_ENGINEERS_RN e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG_RN p
...
-- ============================================================================
INSERT INTO CERTIFICATION_VERIFICATIONS_RN
SELECT
