...
-- ============================================================================
INSERT INTO DISTRIBUTORS_TM VALUES
...
-- ============================================================================
INSERT INTO PRODUCT_CATALOG_TM VALUES
...
-- ============================================================================
INSERT INTO SUPPORT_ENGINEERS_TM
SELECT
...
-- ============================================================================
INSERT INTO DESIGN_ENGINEERS_TM
SELECT
...
-- ============================================================================
INSERT INTO MARKETING_CAMPAIGNS_TM
SELECT
...
-- ============================================================================
INSERT INTO SUPPORT_CONTRACTS_TM
SELECT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_ENGINEERS_TM e
JOIN CUSTOMERS_TM c ON e.customer_id = c.customer_id
CROSS JOIN PRODUCT_CATALOG_TM p
CROSS JOIN DISTRIBUTORS_TM d
...
-- ============================================================================
INSERT INTO PRODUCTION_ORDERS_TM
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS_TM dw
JOIN PRODUCT_CATALOG_TM p ON dw.product_id = p.product_id
...
-- ============================================================================
INSERT INTO CUSTOMER_CAMPAIGN_INTERACTIONS_TM
SELECT
...
FROM CUSTOMERS_TM c
CROSS JOIN MARKETING_CAMPAIGNS_TM mc
...
-- ============================================================================
INSERT INTO SUPPORT_TICKETS_TM
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS_TM c
JOIN DESIGN_ENGINEERS_TM e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG_TM p
...
-- ============================================================================
INSERT INTO CERTIFICATION_VERIFICATIONS_TM
SELECT
