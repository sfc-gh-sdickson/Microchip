...
CREATE OR REPLACE SEMANTIC VIEW SV_DESIGN_ENGINEERING_INTELLIGENCE_TM
  TABLES (
    ...
    production_orders AS RAW_TM.PRODUCTION_ORDERS_TM
    ...
    certifications AS RAW_TM.CERTIFICATIONS_TM
...
WHERE TABLE_SCHEMA = 'ANALYTICS_TM'
  AND table_name LIKE 'SV_%'
ORDER BY table_name;

-- Show semantic view details
SHOW SEMANTIC VIEWS IN SCHEMA ANALYTICS_TM;
