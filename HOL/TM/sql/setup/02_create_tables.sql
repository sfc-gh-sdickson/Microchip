...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMERS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_ENGINEERS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_CONTRACTS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCT_CATALOG_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE DISTRIBUTORS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_WINS_TM (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_TM(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_TM(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_TM(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_TM(distributor_id)
);

-- ============================================================================
-- PRODUCTION_ORDERS TABLE (from COURSE_COMPLETIONS)
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCTION_ORDERS_TM (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (design_win_id) REFERENCES DESIGN_WINS_TM(design_win_id),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_TM(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_TM(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_TM(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_TM(distributor_id)
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATIONS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATION_VERIFICATIONS_TM (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (certification_id) REFERENCES CERTIFICATIONS_TM(certification_id)
);

-- ============================================================================
-- ORDERS TABLE (from TRANSACTIONS)
-- ============================================================================
CREATE OR REPLACE TABLE ORDERS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_TICKETS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_ENGINEERS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE QUALITY_ISSUES_TM (
    ...
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_TM(customer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_TM(product_id),
    FOREIGN KEY (reported_by_engineer_id) REFERENCES DESIGN_ENGINEERS_TM(engineer_id)
);

-- ============================================================================
-- MARKETING_CAMPAIGNS TABLE
-- ============================================================================
CREATE OR REPLACE TABLE MARKETING_CAMPAIGNS_TM (
...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMER_CAMPAIGN_INTERACTIONS_TM (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_TM(customer_id),
    FOREIGN KEY (campaign_id) REFERENCES MARKETING_CAMPAIGNS_TM(campaign_id)
);
