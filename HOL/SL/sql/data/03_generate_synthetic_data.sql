...
-- ============================================================================
INSERT INTO DISTRIBUTORS_SL VALUES
...
-- ============================================================================
INSERT INTO PRODUCT_CATALOG_SL VALUES
...
-- ============================================================================
INSERT INTO SUPPORT_ENGINEERS_SL
SELECT
...
-- ============================================================================
INSERT INTO DESIGN_ENGINEERS_SL
SELECT
...
-- ============================================================================
INSERT INTO MARKETING_CAMPAIGNS_SL
SELECT
...
-- ============================================================================
INSERT INTO SUPPORT_CONTRACTS_SL
SELECT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_ENGINEERS_SL e
JOIN CUSTOMERS_SL c ON e.customer_id = c.customer_id
CROSS JOIN PRODUCT_CATALOG_SL p
CROSS JOIN DISTRIBUTORS_SL d
...
-- ============================================================================
INSERT INTO PRODUCTION_ORDERS_SL
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM DESIGN_WINS_SL dw
JOIN PRODUCT_CATALOG_SL p ON dw.product_id = p.product_id
...
-- ============================================================================
INSERT INTO CUSTOMER_CAMPAIGN_INTERACTIONS_SL
SELECT
...
FROM CUSTOMERS_SL c
CROSS JOIN MARKETING_CAMPAIGNS_SL mc
...
-- ============================================================================
INSERT INTO SUPPORT_TICKETS_SL
SELECT
    ...
    CURRENT_TIMESTAMP() AS updated_at
FROM CUSTOMERS_SL c
JOIN DESIGN_ENGINEERS_SL e ON c.customer_id = e.customer_id
CROSS JOIN PRODUCT_CATALOG_SL p
...
-- ============================================================================
INSERT INTO CERTIFICATION_VERIFICATIONS_SL
SELECT
