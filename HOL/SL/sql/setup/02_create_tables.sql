...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMERS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_ENGINEERS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_CONTRACTS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCT_CATALOG_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE DISTRIBUTORS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE DESIGN_WINS_SL (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_SL(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_SL(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_SL(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_SL(distributor_id)
);

-- ============================================================================
-- PRODUCTION_ORDERS TABLE (from COURSE_COMPLETIONS)
-- ============================================================================
CREATE OR REPLACE TABLE PRODUCTION_ORDERS_SL (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    updated_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (design_win_id) REFERENCES DESIGN_WINS_SL(design_win_id),
    FOREIGN KEY (engineer_id) REFERENCES DESIGN_ENGINEERS_SL(engineer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_SL(product_id),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_SL(customer_id),
    FOREIGN KEY (distributor_id) REFERENCES DISTRIBUTORS_SL(distributor_id)
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATIONS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE CERTIFICATION_VERIFICATIONS_SL (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (certification_id) REFERENCES CERTIFICATIONS_SL(certification_id)
);

-- ============================================================================
-- ORDERS TABLE (from TRANSACTIONS)
-- ============================================================================
CREATE OR REPLACE TABLE ORDERS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_TICKETS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE SUPPORT_ENGINEERS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE QUALITY_ISSUES_SL (
    ...
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_SL(customer_id),
    FOREIGN KEY (product_id) REFERENCES PRODUCT_CATALOG_SL(product_id),
    FOREIGN KEY (reported_by_engineer_id) REFERENCES DESIGN_ENGINEERS_SL(engineer_id)
);

-- ============================================================================
-- MARKETING_CAMPAIGNS TABLE
-- ============================================================================
CREATE OR REPLACE TABLE MARKETING_CAMPAIGNS_SL (
...
-- ============================================================================
CREATE OR REPLACE TABLE CUSTOMER_CAMPAIGN_INTERACTIONS_SL (
    ...
    created_at TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP(),
    FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_SL(customer_id),
    FOREIGN KEY (campaign_id) REFERENCES MARKETING_CAMPAIGNS_SL(campaign_id)
);
