...
CREATE OR REPLACE SEMANTIC VIEW SV_DESIGN_ENGINEERING_INTELLIGENCE_SL
  TABLES (
    ...
    production_orders AS RAW_SL.PRODUCTION_ORDERS_SL
    ...
    certifications AS RAW_SL.CERTIFICATIONS_SL
...
WHERE TABLE_SCHEMA = 'ANALYTICS_SL'
  AND table_name LIKE 'SV_%'
ORDER BY table_name;

-- Show semantic view details
SHOW SEMANTIC VIEWS IN SCHEMA ANALYTICS_SL;
