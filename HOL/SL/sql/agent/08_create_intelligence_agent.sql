...
GRANT USAGE ON DATABASE MICROCHIP_INTELLIGENCE_SL TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL TO ROLE SYSADMIN;
GRANT USAGE ON SCHEMA MICROCHIP_INTELLIGENCE_SL.RAW_SL TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.SV_DESIGN_ENGINEERING_INTELLIGENCE_SL TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.SV_SALES_REVENUE_INTELLIGENCE_SL TO ROLE SYSADMIN;
GRANT REFERENCES, SELECT ON SEMANTIC VIEW MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.SV_CUSTOMER_SUPPORT_INTELLIGENCE_SL TO ROLE SYSADMIN;
GRANT USAGE ON WAREHOUSE MICROCHIP_WH_SL TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.SUPPORT_TRANSCRIPTS_SEARCH_SL TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.APPLICATION_NOTES_SEARCH_SL TO ROLE SYSADMIN;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.QUALITY_INVESTIGATION_REPORTS_SEARCH_SL TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.PREDICT_REVENUE_SL(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.PREDICT_CUSTOMER_CHURN_SL(STRING) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE MICROCHIP_INTELLIGENCE_SL.ANALYTICS_SL.PREDICT_DESIGN_WIN_CONVERSION_SL(STRING) TO ROLE SYSADMIN;
...
GRANT USAGE ON AGENT MICROCHIP_INTELLIGENCE_AGENT_SL TO ROLE SYSADMIN;
