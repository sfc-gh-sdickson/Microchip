...
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.SUPPORT_TRANSCRIPTS_SEARCH_SL TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.APPLICATION_NOTES_SEARCH_SL TO ROLE <your_role>;
GRANT USAGE ON CORTEX SEARCH SERVICE MICROCHIP_INTELLIGENCE_SL.RAW_SL.QUALITY_INVESTIGATION_REPORTS_SEARCH_SL TO ROLE <your_role>;
```
...
1. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_SL.RAW_SL.SUPPORT_TRANSCRIPTS_SEARCH_SL`
2. **Add a description**:
   ```
...
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_SL.RAW_SL.APPLICATION_NOTES_SEARCH_SL`
3. **Add a description**:
   ```
...
1. Click **+ Add** again for another Cortex Search
2. **Select Cortex Search Service**: `MICROCHIP_INTELLIGENCE_SL.RAW_SL.QUALITY_INVESTIGATION_REPORTS_SEARCH_SL`
3. **Add a description**:
   ```
...
SELECT PARSE_JSON(
  SNOWFLAKE.CORTEX.SEARCH_PREVIEW(
      'MICROCHIP_INTELLIGENCE_SL.RAW_SL.SUPPORT_TRANSCRIPTS_SEARCH_SL',
